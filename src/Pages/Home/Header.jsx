...
const AutoCarouselHeader = () => {
  ...
  const slides = [
    {
      id: 1,
      image: eco,  // store the image path in a key
      title: "",
      subtitle: "",
      description: "",
    },
  ...
  return (
    <div className="w-full">
      {/* Carousel Header Section - Mobile Optimized */}
      <div className="relative w-full h-screen min-h-[500px] max-h-screen overflow-hidden">
        {/* Carousel Container */}
                ...
                <div className="absolute inset-0 flex items-center justify-center px-3 sm:px-4 lg:px-8">
                  <div className="w-full max-w-7xl mx-auto">
                    <div className="text-center px-2 sm:px-4">
                      {/* Mobile-first title with better scaling */}
                      {slide.title && (
                        <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-2 xs:mb-3 sm:mb-4 leading-tight animate-fade-in">
                          {slide.title}
                        </h1>
                      )}
                      ...
                      {/* Mobile CTA Button - Only show if content exists */}
      ...
      {/* Fully Mobile-Optimized YouTube Video Section */}
            ...
            <div className="relative bg-gradient-to-br from-white to-gray-100 rounded-lg xs:rounded-xl sm:rounded-2xl shadow-md xs:shadow-lg sm:shadow-2xl overflow-hidden border border-gray-200 mx-1 xs:mx-2 sm:mx-0">
              ...
              <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                <iframe
                  ...
                  src="https://www.youtube.com/embed/hUZeVqmaUMY?start=517"
                  title="Project Video"
                  frameBorder="0"
