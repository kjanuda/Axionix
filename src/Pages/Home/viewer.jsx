...
import { ZoomIn, ZoomOut, Download, ExternalLink, FileText } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
          ...
          <p className="mt-2 text-gray-600">
            Explore the introduction guide. Use zoom, full view, or download for the best experience.
          </p>
        </div>
      </div>

      {/* Top Download Button */}
      <div className="flex justify-end max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        <a
          href={pdfDownloadUrl}
          target="_blank"
